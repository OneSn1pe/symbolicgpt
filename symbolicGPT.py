...
target = 'Skeleton' #'Skeleton' #'EQ'
dataFolder = '/Users/kaustubhkislay/Downloads/SymbolicGPT/Datasets/1-9Var_RandSupport_FixedLength_-3to3_-5.0to-3.0-3.0to5.0_20-250'
...
if os.path.isfile(train_file) and not scratch:
    ...
    path = '/Users/kaustubhkislay/Downloads/SymbolicGPT/Datasets/1-9Var_RandSupport_FixedLength_-3to3_-5.0to-3.0-3.0to5.0_20-250/Train/*'   
