...
from utils import set_seed, sample_from_model, processDataFiles, CharDataset, relativeErr
...
numVars=2 # the dimension of input points x, if you don't know then use the maximum
...
dataTestFolder = '2Var_RandSupport_FixedLength_-3to3_-5.0to-3.0-3.0to5.0_200Points/Test'
